    ...
    return $(this).each(function() {
      ...
      $(keys).each(function(i, key) {
          if (currentKey.name == key.name)
              ...
              keyLinks.push("<a href='#' class='selected' data-key=" + key.name +">" + i + "</a>");
          else
              keyLinks.push("<a href='#' data-key=" + key.name +">" + i + "</a>");
      });
      ...
      $("a", keysHtml).click(function(e) {
          e.preventDefault();
          transposeSong($this, $(this).data("key"));
